...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Revision.docker_image_name'
        db.add_column(u'dokku_controller_revision', 'docker_image_name',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Revision.docker_image_name'
        db.delete_column(u'dokku_controller_revision', 'docker_image_name')
    ...
    models = {
        ...
        u'dokku_controller.deployment': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'waiting_for_deploy'", 'max_length': '32'})
        },
        ...
        u'dokku_controller.revision': {
            ...
            'docker_image_name': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
