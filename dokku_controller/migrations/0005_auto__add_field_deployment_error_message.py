...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deployment.error_message'
        db.add_column(u'dokku_controller_deployment', 'error_message',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deployment.error_message'
        db.delete_column(u'dokku_controller_deployment', 'error_message')
